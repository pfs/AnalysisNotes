...
and which is expected to be robust to the main systematic uncertainties affecting the $m_{\rm t}$ measurement. In order to control the main theory systematic, pertaining the modelling of the b quark fragmentation and hadronization, we study charmed mesons reconstructed inside jets in \ttbar events.
